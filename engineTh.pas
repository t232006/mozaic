...
procedure engineTh.Execute;
begin
  { Place thread code here }
end;

function engineTh.GetMap(FPicture: TBitmap; ColCount, RowCount,
  colorCount: integer): TMap;
var Map: TMap;
...
function engineTh.Quantor(num, min, max, colorcount: integer): integer;
